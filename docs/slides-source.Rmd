...
library(RBitmoji)
my_id <- "ebb3cf19-34bb-4caf-a5c5-abe3ec6cec35-v1"
...
## .font130[with an example implementation in `r anicon::faa("r-project", animate = 'pulse', speed = 'slow', color = 'steelblue')`]

### Brad Boehmke
### 2018-12-05
### Slides: [bit.ly/8451-random-forest](http://bit.ly/8451-random-forest)
...
```{r interaction-pdp-output, echo=FALSE}
pdp <- fit_final %>%
    partial(
        pred.var = c("Gr_Liv_Area", "Year_Built"),
        train = as.data.frame(ames_train)
